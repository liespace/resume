\resheading{研究经历}
  \begin{itemize}[leftmargin=*]
    \item \ressubsingleline{针对自动驾驶的运动规划}{}{2018.09 -- 目前}{\small
    	\begin{itemize}
    		\item{硕士阶段的研究领域是自动驾驶的运动规划，研究方向是深度学习方法与经典运动规划方法的结合：利用深度卷积网络(如YOLO等)为基于采样的路径规划算法(如RRT*等)提供高效的启发。}
    		\item{研究所用的仿真实验平台基于CARLA和ROS框架搭建，神经网络则基于Tensorflow和Keras框架搭建。}
